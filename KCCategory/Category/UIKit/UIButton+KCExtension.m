...
- (void)kc_layoutSubviews
{
    ...
    if (self.kc_imagePosition != KCButtonImagePositionDefault) {
        CGFloat margin = self.kc_imageTitleSpacing;
        KCButtonImagePosition position = self.kc_imagePosition;
...
{
    self.kc_imagePosition = postion;
    self.kc_imageTitleSpacing = margin;
